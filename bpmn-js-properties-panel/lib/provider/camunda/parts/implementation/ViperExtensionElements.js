...
module.exports = function(element, bpmnFactory, options) {
  ...
  var createElement = options.createExtensionElement,
      canCreate     = options.canCreate || typeof createElement === 'function';

  var removeElement = options.removeExtensionElement,
      canRemove     = options.canRemove || typeof removeElement === 'function';
  ...
  return {
    ...
    createElement: function(element, node, variable) {
